...
int main(void)
{
  ...
  /* USER CODE BEGIN WHILE */
	...
	//HAL_UART_Transmit(&huart5, (uint8_t*)&RData, 1, HAL_MAX_DELAY);
	Led_ctor(&led1,RED,OFF);
	Led_ctor(&led2,GREEN,ON);
  ...
  while (1)
  {
		//HAL_UART_Transmit(&huart5, (uint8_t*)RData, 20, HAL_MAX_DELAY);
		//printf("Hello there from main function\n\r");
		/*HAL_GPIO_ReadPin(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin)*/
	  //if(HAL_GPIO_ReadPin(GPIOA, PB_Pin))
